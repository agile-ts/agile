...
describe('Default State Tests', () => {
    ...
    describe('State with Key', () => {
        ...
        it('Has correct initial values', () => {
            ...
            expect(MY_STATE_WITH_KEY._key).to.eq('myKey', 'MY_STATE_WITH_KEY has correct _key');
        });
        ...
        it('Can change key', () => {
            ...
            expect(MY_STATE_WITH_KEY.key).to.eq('myNewKey', 'MY_STATE_WITH_KEY has correct key');
            expect(MY_STATE_WITH_KEY._key).to.eq('myNewKey', 'MY_STATE_WITH_KEY has correct _key');
        });
