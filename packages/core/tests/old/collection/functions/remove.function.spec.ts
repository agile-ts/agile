...
describe("Remove Function Tests", () => {
  ...
  describe("Remove Function 'removeFromGroups'", () => {
    ...
    it("Can remove item which exist", async () => {
      ...
      expect(JSON.stringify(MY_COLLECTION.groups["group2"].value)).to.eq(
        JSON.stringify([1, 2, 3]),
        "group2 has correct value"
      );
      expect(MY_COLLECTION.data[1] instanceof Item).to.eq(
        true,
        "MY_COLLECTION has item with id 1"
      );
      expect(MY_COLLECTION.size).to.eq(3, "MY_COLLECTION has correct size");
    ...
    it("Can remove items which exist", async () => {
      ...
      expect(MY_COLLECTION.data[2] instanceof Item).to.eq(
        true,
        "MY_COLLECTION has item with id 2"
      );
      expect(MY_COLLECTION.data[3] instanceof Item).to.eq(
        true,
        "MY_COLLECTION has item with id 3"
      );
      expect(MY_COLLECTION.size).to.eq(3, "MY_COLLECTION has correct size");
  ...
  describe("Remove Function 'everywhere'", () => {
    ...
    it("Can remove item which exist", async () => {
      ...
      expect(MY_COLLECTION.data[1] instanceof Item).to.eq(
        false,
        "MY_COLLECTION hasn't item with id 1"
      );
    ...
    it("Can remove items which exist", async () => {
      ...
      expect(MY_COLLECTION.data[2] instanceof Item).to.eq(
        false,
        "MY_COLLECTION hasn't item with id 2"
      );
      expect(MY_COLLECTION.data[3] instanceof Item).to.eq(
        false,
        "MY_COLLECTION hasn't item with id 3"
      );
