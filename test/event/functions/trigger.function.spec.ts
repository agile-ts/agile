...
import {useEvent} from "../../../src/integrations/test";
...
describe('Trigger Function Tests', () => {
    ...
    describe('Event', () => {
        ...
        it('Has correct initial value', () => {
            ...
            expect(MY_EVENT.callbacks.size).to.eq(2, 'MY_EVENT has correct callbacks size');
        ...
        it('Can trigger enabled Event', async () => {
            ...
            expect(JSON.stringify(currentEventPayload)).to.eq(JSON.stringify({title: "Hello", message: "There"}), 'currentEventPayload has correct value');
        });
