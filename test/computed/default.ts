...
describe('Default Computed Tests', () => {
    ...
    describe('Computed', () => {
        ...
        it('Has correct initial values', () => {
            ...
            expect(JSON.stringify(MY_COMPUTED.deps)).to.eq(JSON.stringify([MY_STATE, MY_STATE_2, MY_SELECTOR, MY_COLLECTION.findById(2)]), 'MY_COMPUTED has correct hardCodedDeps');
    ...
    describe('Computed with initial subs', () => {
        ...
        it('Has correct initial values', () => {
            ...
            expect(JSON.stringify(MY_COMPUTED.deps)).to.eq(JSON.stringify([MY_STATE_3, MY_STATE, MY_STATE_2, MY_SELECTOR, MY_COLLECTION.findById(2)]), 'MY_COMPUTED has correct hardCodedDeps');
            expect(computedCallCount).to.eq(2, 'computedCallCount has correct initial value');
        });
