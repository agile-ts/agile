...
describe('FindById Function Tests', () => {
    ...
    it('Has correct initial values', () => {
        ...
        expect(JSON.stringify(MY_COLLECTION.data[2].value)).to.eq(JSON.stringify({id: 2, name: 'hans'}), 'MY_COLLECTION has correct data');
    ...
    it('Can\'t findById not existing item', () => {
        ...
        expect(item instanceof State).to.eq(false, 'item isn\'t instanceof State')
    });
});
